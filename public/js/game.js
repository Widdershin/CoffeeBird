...
(function() {
  var continueGame, game, gameStarted,
  ...
  window.onload = function() {
    var Bird, Game, GameObject, Key, Pipe, birdSprite, gameStarter, gravity, pipeSprite;
    ...
    Game = (function() {
      ...
      Game.prototype.update = function() {
        ...
        if (this.pipeAt(this.bird.x, this.bird.y)) {
          this.stop();
        }
        this.bird.update();
        _ref = this.pipes;
    ...
    GameObject = (function() {
      ...
      GameObject.prototype.draw = function(ctx) {
        return ctx.drawImage(this.sprite, this.x + this.spriteOffsetX, this.y + this.spriteOffsetY);
      };

      GameObject.prototype.debug_draw = function(ctx) {
        ctx.fillStyle = 'red';
    ...
    Pipe = (function(_super) {
      ...
      Pipe.prototype.debug_draw = function(ctx) {
        Pipe.__super__.debug_draw.apply(this, arguments).ctx;
        ctx.fillStyle = 'red';
        ctx.beginPath();
